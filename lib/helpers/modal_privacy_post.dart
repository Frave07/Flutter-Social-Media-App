      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Center(
              child: TextFrave(text: 'Quienes pueden comentar?', fontWeight: FontWeight.w500 )
            ),
            
            const SizedBox(height: 15.0),
            const TextFrave(text: 'Selecciona quienes pueden comentar tu\npublicación.', fontSize: 16, color: Colors.grey, maxLines: 2),
            ...
            InkWell(
              ...
              child: Row(
                children: [
                  ...
                  const TextFrave(text: 'Todos', fontSize: 17,)
                ],
              ),
            ),
            const SizedBox(height: 20.0),
            InkWell(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 10.0),
                  const TextFrave(text: 'Solor seguidores', fontSize: 17,)
                ],
              ),
            ),
            const SizedBox(height: 20.0),
            InkWell(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 10.0),
                  const TextFrave(text: 'Nadie', fontSize: 17,)
                ],
              ),
            ),
