                ...
                child: Align(
                  ...
                  child: Row(
                    children: const [
                      ...
                      SizedBox(width: 10.0),
                      TextFrave(text: 'Reportar', fontSize: 17, color: Colors.red),
                    ],
                  ))
              ),
            ),
                ...
                child: Align(
                  ...
                  child: Row(
                    children: const [
                      ...
                      SizedBox(width: 10.0),
                      TextFrave(text: 'Bloquear', fontSize: 17),
                    ],
                  ))
              ),
            ),
                ...
                child: Align(
                  ...
                  child: Row(
                    children: const [
                      ...
                      SizedBox(width: 10.0),
                      TextFrave(text: 'Copiar URL del perfil', fontSize: 17),
                    ],
                  ))
              ),
            ),
                ...
                child: Align(
                  ...
                  child: Row(
                    children: const [
                      ...
                      SizedBox(width: 10.0),
                      TextFrave(text: 'Compartir este perfil', fontSize: 17),
                    ],
                  ))
              ),
            ),
